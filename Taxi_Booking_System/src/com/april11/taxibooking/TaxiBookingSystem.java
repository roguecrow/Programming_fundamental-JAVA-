	...
	public static void main(String[] args) {
		...
		try {
			if(validate.intInputChecker(cabType) && validate.intInputChecker(distance)) {
				...
				DiscountCalculator disCalculator = new DiscountCalculator();
				...
				if(fareAmount > minAmount) {
					...
					System.out.println("Total Fare with added Discount :" + disCalculator.FinalAmountCalculator(sc,fareAmount));
